...
def compute_hilo_elite(bars: Sequence[Bar], *, timeframe: Timeframe = "1D") -> HiLoEliteSeries:
    ...
    slow_k, slow_d = stochastic_full(
        ...
        over_bought=80.0,
        over_sold=20.0,
        k_period=config.slow_d_k_period,
        d_period=config.slow_d_d_period,
        slowing_period=config.slow_d_slowing,
    )
    slow_k_x, slow_d_x = stochastic_full(
        ...
        over_bought=80.0,
        over_sold=20.0,
        k_period=config.slow_d_x_k_period,
        d_period=config.slow_d_x_d_period,
        slowing_period=config.slow_d_x_slowing,
    )
