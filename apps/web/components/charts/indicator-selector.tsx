...
const BUCKETS: Array<{
  ...
  { key: "momentum_intelligence", label: "Momentum Intelligence", hint: "True Momentum, HiLo Elite, and composite score strips (deterministic context).", categories: ["momentum_intelligence"] },
];
