...
def test_haco_30m_route_returns_numeric_intraday_canonical_axis(monkeypatch) -> None:
    ...
    assert [point["time"] for point in payload["haco_strip"]] == candle_times
    assert [point["time"] for point in payload["hacolt_strip"]] == candle_times
